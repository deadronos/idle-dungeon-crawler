...
export const useGame = () => {
    ...
    const actions: GameActions = {
        ...
        unlockTalent: useGameStore((store) => store.unlockTalent),
        equipItem: useGameStore((store) => store.equipItem),
        unequipItem: useGameStore((store) => store.unequipItem),
        getInventoryCapacityUpgradeCost: useGameStore((store) => store.getInventoryCapacityUpgradeCost),
        buyInventoryCapacityUpgrade: useGameStore((store) => store.buyInventoryCapacityUpgrade),
